...
declare function Select({ thickness, options, onChange, value, selectHelp, name, placeholder, error, disabled, searchEable, labelInLine, loading, ellipsis, helpIcon, controlStates, position, popoverContainer, required, customClass, ...props }: SelectI): JSX.Element;
